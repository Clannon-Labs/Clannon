      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-8 px-5 py-12 sm:flex-row sm:items-start sm:justify-between">
        ...
        <nav aria-label="Footer" className="grid grid-cols-2 gap-x-12 gap-y-2 text-sm sm:grid-cols-3 sm:gap-x-16">
          <div className="flex flex-col gap-2.5">
            <span className="tag-label text-faint">Product</span>
          ...
          <div className="flex flex-col gap-2.5">
            <span className="tag-label text-faint">Account</span>
            <Link href="/login" className="text-muted-foreground hover:text-foreground">Sign in</Link>
            <Link href="/signup" className="text-muted-foreground hover:text-foreground">Start free</Link>
          </div>
          <div className="flex flex-col gap-2.5">
            <span className="tag-label text-faint">Legal</span>
