...
class DocumentationExpert:
    ...
    tools = ("fs.read", "fs.write")  # read attached source docs, write + deliver the doc; prior docs/decisions arrive via the pushed hydration + the orchestrator's brokered recall (sole-broker, §7.3)
