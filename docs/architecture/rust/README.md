...
| [`RUST_IDIOMS_AND_CRATES.md`](RUST_IDIOMS_AND_CRATES.md) | Which Rust features and crates to use where, and what they replace. | tables | choosing how to build a piece |
